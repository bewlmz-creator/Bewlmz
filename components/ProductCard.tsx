...
import { Star, Heart, Zap, Image as ImageIcon } from 'lucide-react';
          ...
          {product.image && !imageError ? (
            ...
            />
             ...
             <div className="flex flex-col items-center gap-1 text-slate-300">
               ...
               <span className="text-[5px] md:text-[7px] font-black uppercase tracking-widest text-slate-400 px-2 text-center">Loading Image...</span>
             </div>
          )}
